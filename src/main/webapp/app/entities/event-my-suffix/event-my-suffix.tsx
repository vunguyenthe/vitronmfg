...
export type IEventMySuffixState = IPaginationBaseState;

export class EventMySuffix extends React.Component<IEventMySuffixProps, IEventMySuffixState> {
  state: IEventMySuffixState = {
              ...
              {eventList.map((event, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {event.newIconPath ? (
                      <div>
                        <a onClick={openFile(event.newIconPathContentType, event.newIconPath)}>
                          <img src={`data:${event.newIconPathContentType};base64,${event.newIconPath}`} style={{ maxHeight: '30px' }} />
                          &nbsp;
                        </a>
                        <span>
                          {event.newIconPathContentType}, {byteSize(event.newIconPath)}
                        </span>
                      </div>
                    ) : null}
                  </td>
